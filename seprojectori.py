...
class Product:
    def _init_(self, name, max_order_limit, current_stock, price):
        self.name = name
...
class Lab:
    def _init_(self, city, name, phone, postal_code):
        self.city = city
        self.name = name
        self.phone = phone
...
class Transaction:
    def _init_(self, product_name, quantity, total_price, date):
